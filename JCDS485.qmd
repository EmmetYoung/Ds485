...
ggplot(data = melted_corr_mat,  aes(x=Var1, y=Var2, fill=value)) +   geom_tile() +  scale_fill_distiller(palette="RdBu",direction=1,limits=c(-1,1))+  geom_text(aes(Var2, Var1, label = value),           color = "black", size = 4)
